...
$string['assignquestioncategories'] = 'Assign question categories to this activity';
...
$string['configurequestioncategories'] = 'Configure question categories';
...
$string['launch_mobile_tapqr'] = 'Tap the QR code, then long-press it in the next view to share it to the MooDuell app.';
...
$string['launchcolor_background_desc'] = 'Main background color used in the launch preview block.';
$string['launchcolor_primary'] = 'Launch primary color';
$string['launchcolor_primary_desc'] = 'Primary brand color used for status/header accents and the login QR button.';
$string['launchcolor_secondary'] = 'Launch secondary color';
$string['launchcolor_secondary_desc'] = 'Secondary brand color used for store buttons.';
$string['launchcolor_surface'] = 'Launch surface color';
$string['launchcolor_surface_desc'] = 'Secondary surface color used in launch background gradients.';
$string['launchcolor_text'] = 'Launch text color';
$string['launchcolor_text_desc'] = 'Main text color used in the launch preview sidebar.';
$string['launchcolor_textmuted'] = 'Launch muted text color';
$string['launchcolor_textmuted_desc'] = 'Muted text color for descriptions and feature bullets.';
$string['launchthememode'] = 'Launch theme source';
$string['launchthememode_custom'] = 'Use custom MooDuell launch colors';
$string['launchthememode_desc'] = 'Choose whether the launch preview should inherit Moodle styling or use custom corporate colors.';
$string['launchthememode_inherit'] = 'Inherit Moodle theme palette';
...
$string['nocategoriesassigned'] = 'No question categories are assigned to this activity yet.';
$string['nocoursequestioncategories'] = 'This course has no question banks or categories yet.';
...
$string['shortcode_mooduell_description'] = 'Embeds the MooDuell web app as an authenticated iframe. Every shortcode usage must pass the configured securitytoken. Example: [mooduell securitytoken=ABCDEFGH] or [mooduell randomuserfromcourse=12 securitytoken=ABCDEFGH].';
$string['shortcode_warning_invalid_securitytoken'] = 'The MooDuell shortcode security token is invalid.';
$string['shortcode_warning_missing_mooduell_instance'] = 'The target course ({$a}) does not contain a MooDuell activity, so rotating course users cannot be used here.';
$string['shortcode_warning_missing_securitytoken'] = 'This MooDuell shortcode requires a securitytoken parameter.';
$string['shortcode_warning_no_eligible_user'] = 'No eligible MooDuell user could be resolved for the target course ({$a}).';
$string['shortcodetoken'] = 'Shortcode security token';
$string['shortcodetoken_desc'] = 'Security token required for all MooDuell shortcode usages. A random 8-character token is generated by default. Only shortcodes that pass the same token in the securitytoken parameter will render.';
