...
$string['webappurl'] = 'Link to the MooDuell Web App (frame.html)';
$string['webappurldesc'] = 'Used by the "Start MooDuell" button in the QR login dialog.';
...
$string['licenselimit_newactivity_blocked'] = 'Your MooDuell license user limit has been exceeded. Creating new MooDuell activities is blocked.';
$string['licenselimit_newgame_blocked'] = 'Your MooDuell license user limit has been exceeded. Creating new games is blocked.';
$string['licenselimit_over_warning'] = 'You are currently at {$a->current} of {$a->limit} users for your MooDuell license ({$a->percentage}%). You are over the license limit: creating new games and creating new MooDuell activities is now blocked.';
...
$string['showqrlogin'] = 'Show QR to Login';
$string['startmooduell'] = 'Start MooDuell';
$string['launch_eyebrow'] = 'MooDuell Web Preview';
$string['launch_tagline'] = 'The Moodle Quiz Duel';
$string['launch_title'] = 'Challenge your colleagues to a quiz duel.';
$string['launch_description'] = 'Scan a QR code to install the app instantly, then scan your personal login QR to sign in.';
...
$string['appstore_qr_title'] = 'App Store QR';
$string['playstore_qr_title'] = 'Google Play QR';
$string['login_qr_title'] = 'Login QR';
$string['appstore_qr_desc'] = 'Scan this QR code with your phone to open the Apple App Store download page.';
$string['playstore_qr_desc'] = 'Scan this QR code with your phone to open the Google Play download page.';
$string['openappstore'] = 'Open App Store';
$string['openplaystore'] = 'Open Google Play';
