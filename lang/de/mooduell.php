...
$string['appstore_qr_desc'] = 'Scanne diesen QR-Code mit deinem Smartphone, um die Download-Seite im Apple App Store zu öffnen.';
$string['appstore_qr_title'] = 'App-Store-QR-Code';
$string['appstorebutton'] = 'App Store';
$string['appstoreurl'] = "Link zum Apple App Store";
$string['assignquestioncategories'] = 'Fragenkategorien dieser Aktivität zuweisen';
...
$string['configurequestioncategories'] = 'Fragenkategorien konfigurieren';
...
$string['launch_description'] = 'Scanne einen QR-Code, um die App direkt zu installieren, und danach deinen persönlichen Login-QR-Code zum Anmelden.';
$string['launch_eyebrow'] = 'MooDuell Web-Vorschau';
$string['launch_feature_one'] = 'Duelle gegen alle Moodle-Nutzer*innen mit Einmal-Login-Tokens';
...
$string['launchcolor_background_desc'] = 'Haupt-Hintergrundfarbe des Launch-Vorschaublocks.';
$string['launchcolor_primary'] = 'Launch-Primärfarbe';
$string['launchcolor_primary_desc'] = 'Primäre Markenfarbe für Status/Header-Akzente und den Login-QR-Button.';
$string['launchcolor_secondary'] = 'Launch-Sekundärfarbe';
$string['launchcolor_secondary_desc'] = 'Sekundäre Markenfarbe für die Store-Buttons.';
$string['launchcolor_surface'] = 'Launch-Surface-Farbe';
$string['launchcolor_surface_desc'] = 'Zweite Flächenfarbe für die Launch-Hintergrundverläufe.';
$string['launchcolor_text'] = 'Launch-Textfarbe';
$string['launchcolor_text_desc'] = 'Haupttextfarbe in der Launch-Vorschau-Seitenleiste.';
$string['launchcolor_textmuted'] = 'Launch-Textfarbe (dezent)';
$string['launchcolor_textmuted_desc'] = 'Dezente Textfarbe für Beschreibungen und Feature-Aufzählungen.';
$string['launchthememode'] = 'Quelle für Launch-Theme';
$string['launchthememode_custom'] = 'Eigene MooDuell-Launchfarben verwenden';
$string['launchthememode_desc'] = 'Wählen Sie, ob die Launch-Vorschau das Moodle-Theme erben oder eigene Corporate-Farben verwenden soll.';
$string['launchthememode_inherit'] = 'Moodle-Theme-Palette übernehmen';
$string['launchthemesettings'] = 'Design der Launch-Vorschau';
...
$string['ok'] = 'OK';
$string['openappstore'] = 'App Store öffnen';
$string['opengames'] = 'Offene Spiele';
$string['openplaystore'] = 'Google Play öffnen';
...
$string['playstore_qr_desc'] = 'Scanne diesen QR-Code mit deinem Smartphone, um die Download-Seite in Google Play zu öffnen.';
$string['playstore_qr_title'] = 'Google-Play-QR-Code';
$string['playstorebutton'] = 'Google Play';
...
$string['shortcode_mooduell_description'] = 'Bettet die MooDuell-Web-App als authentifizierten iFrame ein. Jede Shortcode-Verwendung muss den konfigurierten securitytoken übergeben. Beispiel: [mooduell securitytoken=ABCDEFGH] oder [mooduell randomuserfromcourse=12 securitytoken=ABCDEFGH].';
$string['shortcode_warning_invalid_securitytoken'] = 'Der Sicherheitstoken des MooDuell-Shortcodes ist ungültig.';
$string['shortcode_warning_missing_mooduell_instance'] = 'Der Zielkurs ({$a}) enthält keine MooDuell-Aktivität, daher können hier keine rotierenden Kursnutzer verwendet werden.';
$string['shortcode_warning_missing_securitytoken'] = 'Dieser MooDuell-Shortcode benötigt einen securitytoken-Parameter.';
$string['shortcode_warning_no_eligible_user'] = 'Für den Zielkurs ({$a}) konnte kein geeigneter MooDuell-Nutzer ermittelt werden.';
$string['shortcodetoken'] = 'Shortcode-Sicherheitstoken';
$string['shortcodetoken_desc'] = 'Sicherheitstoken für alle MooDuell-Shortcodes. Standardmäßig wird ein zufälliger 8-stelliger Token erzeugt. Nur Shortcodes, die denselben Token im Parameter securitytoken übergeben, werden gerendert.';
...
$string['showqrlogin'] = 'QR-Code zum Login anzeigen';
$string['startmooduell'] = 'MooDuell starten';
