...
namespace mod_mooduell\local\wunderbyte_table\local\customfield;

use mod_mooduell\local\wunderbyte_table\local\customfield\field\text\wbt_field_controller;
use stdClass;
use mod_mooduell\local\wunderbyte_table\local\customfield\wbt_field_controller_base;
...
class wbt_field_controller_info {
    ...
    public static function create(stdClass $record) {
        $class = "\\mod_mooduell\local\wunderbyte_table\\local\\customfield\\field\\{$record->type}\\wbt_field_controller";
