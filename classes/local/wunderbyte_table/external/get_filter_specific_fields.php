...
namespace mod_mooduell\local\wunderbyte_table\external;

use external_api;
use external_function_parameters;
use external_value;
use external_single_structure;
use mod_mooduell\local\wunderbyte_table\filters\filter_manager;
...
class get_filter_specific_fields extends external_api {
    ...
    public static function execute(
        ...
        $classname = 'mod_mooduell\local\wunderbyte_table\filters\types\datepicker';
