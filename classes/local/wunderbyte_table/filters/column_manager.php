 ...
 */
namespace mod_mooduell\local\wunderbyte_table\filters;
...
class column_manager extends filtersettings {
    ...
    /** @var \mod_mooduell\local\wunderbyte_table\wunderbyte_table */
    protected $table;
    ...
    private function set_general_filter_settings($filtercolumn) {
        $this->mformedit->addElement(
            ...
            get_string('filterenabledheader', 'mod_mooduell')
        );
        ...
        $this->mformedit->addElement(
            ...
            get_string('enablefilter', 'mod_mooduell'),
            get_string('enablefilterdesc', 'mod_mooduell')
        );
        ...
        $this->mformedit->addElement(
            'select',
            'wbfilterclass',
            get_string('setwbtablefiltertype', 'mod_mooduell'),
            $options
        );
    ...
    private function set_available_filter_types($existingfilterdata, $filterclass) {
        $this->mformedit->addElement(
            'header',
            'existing_pairs',
            get_string('filterexistingkeyvaluepairs', 'mod_mooduell')
        );
        ...
        if (
            ...
            $this->mformedit->addElement('html', '<p id="no-pairs-message" class="alert alert-info">'
                . get_string('filternopairsexist', 'mod_mooduell') . '</p>');
        }
    }
    ...
    private function set_add_filter_key_value($newkeyvaluepair, $filterspecificvalue = '') {
        ...
        $this->mformadd->addElement('header', 'add_pair', get_string('filteraddnewkeyvaluepair', 'mod_mooduell'));
    ...
    public function set_filter_columns(\MoodleQuickForm &$mform) {
        ...
        if ($options) {
            $mform->addElement(
                'select',
                'filter_columns',
                get_string('setwbtablefiltercolumn', 'mod_mooduell'),
                $options
            );
    ...
    public function get_all_filter_columns($filterablecolumns) {
        $options = [
            '' => get_string('setwbtablefiltercolumnoption', 'mod_mooduell'),
        ];
