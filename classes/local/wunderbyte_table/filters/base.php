...
use mod_mooduell\local\wunderbyte_table\local\customfield\wbt_field_controller_info;
...
abstract class base {
    ...
    public static function definition(MoodleQuickForm &$mform, array &$formdata, stdClass $filter) {
        ...
        $mform->addElement(
            ...
            get_string('showfilter', 'mod_mooduell'),
            $filter->localizedname
        );
        $mform->addElement(
            'text',
            $filter->columnidentifier . '_wb_localizedname',
            get_string('editfiltername', 'mod_mooduell'),
            $filter->localizedname
        );
    }
    ...
    public static function return_localized_name() {
        ...
        return get_string($classname, 'mod_mooduell');
    }
