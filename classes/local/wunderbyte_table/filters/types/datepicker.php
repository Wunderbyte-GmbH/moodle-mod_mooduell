...
use mod_mooduell\local\wunderbyte_table\filters\types\datepickers\datepicker_factory;
use stdClass;
...
class datepicker extends datepickerbase {
    ...
    public static function set_span_filter_input(&$mform, $valuelabel) {
        $nameinput = $mform->createElement(
            ...
            $valuelabel  . '[name]',
            '',
            ['placeholder' => get_string('datepickerplaceholdername', 'mod_mooduell')]
        );
        ...
        $checkboxlabelinput = $mform->createElement(
            ...
            '',
            ['placeholder' => get_string('datepickerplaceholdercheckboxlabel', 'mod_mooduell')]
        );
        ...
        return [
            $mform->createElement(
                ...
                '',
                '<br><label>' . get_string('datepickerheadingname', 'mod_mooduell') . '</label>'
            ),
            $nameinput,
            $mform->createElement(
                'static',
                ...
                '',
                '<br><label>' . get_string('datepickerheadingcheckboxlabel', 'mod_mooduell') . '</label>'
            ),
            $checkboxlabelinput,
            $mform->createElement(
                'static',
                ...
                '',
                '<br><label>' . get_string('datepickerheadingpossibleoperations', 'mod_mooduell') . '</label>'
            ),
            ...
            $mform->createElement(
                ...
                '',
                '<br><label>' . get_string('datepickerheadingdefaultvaluestart', 'mod_mooduell') . '</label>'
            ),
            ...
            $mform->createElement(
                ...
                '',
                '<br><label>' . get_string('datepickerheadingdefaultvalueend', 'mod_mooduell') . '</label>'
            ),
    ...
    public static function validate_input($data) {
        ...
        foreach ($data['datepicker'] as $datepickername => $datepickerinput) {
            ...
            if (
                ...
                $errormsg .= get_string('datepickererrormandatory', 'mod_mooduell');
            }
            if (
                isset($datepickerinput['operator']) &&
                $datepickerinput['operator'] == '"_qf__force_multiselect_submission"'
            ) {
                $errormsg .= get_string('datepickererroroperations', 'mod_mooduell');
            }
            if (!empty($errormsg)) {
