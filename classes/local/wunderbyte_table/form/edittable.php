...
namespace mod_mooduell\local\wunderbyte_table\form;
...
use mod_mooduell\local\wunderbyte_table\filters\filters_info;
...
class edittable extends dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement(
            ...
            get_string('wbtablefiltersettingsheader', 'mod_mooduell')
        );
        ...
        $mform->addElement(
            ...
            get_string('wbtabletablesettingsheader', 'mod_mooduell')
        );
    ...
    public function validation($data, $files) {
        ...
        if (!is_number($data['gs_wb_pagesize'])) {
            $errors['gs_wb_pagesize'] = get_string('valuehastobeint', 'mod_mooduell');
        }

        if (!is_number($data['gs_wb_infinitescroll'])) {
            $errors['gs_wb_infinitescroll'] = get_string('valuehastobeint', 'mod_mooduell');
        }
    ...
    protected function check_access_for_dynamic_submission(): void {
        ...
        require_capability('mod/mooduell:canedittable', context_system::instance());
    }
}
