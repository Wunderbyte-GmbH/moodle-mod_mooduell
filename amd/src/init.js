...
import {initializeCheckboxes, getFilterObjects, initializeSearchInputListener} from 'mod_mooduell/filter';
import {initializeSearch, getSearchInput} from 'mod_mooduell/search';
import {initializeSort, getSortSelection} from 'mod_mooduell/sort';
import {initializeReload, reloadAllTables} from 'mod_mooduell/reload';
import {initializeActionButton} from 'mod_mooduell/actionbutton';
import {initializeEditTableButton} from 'mod_mooduell/edittable';
import {initializeReordering} from 'mod_mooduell/reordering';
...
export const callLoadData = (
    ...
    Ajax.call([{
        methodname: "mod_mooduell_load_data",
        args: {
            ...
            try {
                ...
                const message = await getString('couldnotloaddata', 'mod_mooduell');
            ...
            if (!componentscontainer) {
                ...
                promises.push(Templates.renderForPromise('mod_mooduell/component_sort', jsonobject).then(({html, js}) => {
