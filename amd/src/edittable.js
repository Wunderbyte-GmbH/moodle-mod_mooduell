...
import {init as filterFieldsInit} from 'mod_mooduell/filterfieldsreload';
import {init as filterColumnsInit} from 'mod_mooduell/filtercolumnsreload';
import {init as deleteKeyValuePairInit} from 'mod_mooduell/deletekeyvaluepair';
...
export function addFilterTableModal(event, idstring, encodedtable) {
    ...
    const modalForm = new ModalForm({
        formClass: "mod_mooduell\\local\\wunderbyte_table\\form\\addfiltertable",
        args: {
            idstring,
            encodedtable,
        },
        modalConfig: {title: getString('addwbtablefilter', 'mod_mooduell')},
        returnFocus: element
    });
    ...
    modalForm.addEventListener('change', (e) => {
        if (e.target.name == 'subdatepicker_type') {
            Ajax.call([{
                methodname: 'mod_mooduell_get_filter_specific_fields',
...
export function editTableModal(event, idstring, encodedtable) {
    ...
    const modalForm = new ModalForm({
        ...
        formClass: "mod_mooduell\\local\\wunderbyte_table\\form\\edittable",
        ...
        modalConfig: {title: getString('customizewbtable', 'mod_mooduell')},
